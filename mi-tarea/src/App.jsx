...
function App() {
  ...
  return (
    <>
      <CartWindow totalItems= {totalItems} cart={groupedCart} total={total} increaseQuantity={increaseQuantity} decreaseQuantity={decreaseQuantity} removeProduct={removeProduct}/>
